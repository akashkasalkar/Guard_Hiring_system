					...
					<div class="col">
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							<div class="header_content_inner d-flex flex-row align-items-end justify-content-start">
								<div class="logo"><a href="index.php" style="font-size:55px;color: white; text-shadow:5px 5px 5px red">		
								...
								<nav class="main_nav">
									<ul class="d-flex flex-row align-items-start justify-content-start">
										<li class="text-dark active" id="home_li"><a onclick="active('home')"
												href="#home" style="color: #fff; font-size:30px;">Home</a>
										</li>
										
										<!-- <li><a href="#">Services</a></li> -->
										<li id="product_li" class=""><a href="#product" onclick="active('product')"
												style="color: #fff; font-size:30px;">Signup</a></li>
										<li id="testimonials2_li" class=""><a href="#testimonials2"
												onclick="active('testimonials2')" style="color: #fff; font-size:30px;">Login</a>
										</li>
		...
		<div class="home" id="home">
			...
			<div class="home_slider_container">
				<div class="owl-carousel owl-theme home_slider">
					<!-- Slide -->
					<div class="owl-item">
						<div class="background_image" style="background-image:url(./images/cover11.jpg)"></div>
									...
									<div class="col">
										<div class="home_slider_content">
											<div class="home_title">
												<h2 style="color: white; text-shadow:5px 5px 5px red">"Guardians of Safety: Protecting Today, Securing Tomorrow."</h2>
											</div>
										</div>
									</div>
								</div>
